...
typedef RegisterBoxProps = {redirectUrl:String,message:String,phoneRequired:Bool,addressRequired:Bool};
			...
			<div>
				...
				<form action="" method="post" className="form-horizontal">
					...
					<p className="text-center">
						...
						<span className="glyphicon glyphicon-chevron-right"></span> Inscription</a>
					</p>
				</form>
				<hr/>
				<p className="text-center">
